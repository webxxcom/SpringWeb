...
public class WarehouseService {
    ...
    @Autowired
    public WarehouseService(DAOFactory mySqlDaoFactory, ConnectionManager cm) {
        Objects.requireNonNull(mySqlDaoFactory, "DAO factory cannot be null");

        this.allProductsDAO = null;//mySqlDaoFactory.getAllProductsDAO();
        this.customerDAO = mySqlDaoFactory.getCustomerDAO(cm);
        this.supplierDAO = null;//mySqlDaoFactory.getSupplierDAO();
    }
